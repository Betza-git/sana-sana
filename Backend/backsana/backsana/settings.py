"""
Django settings for backsana project.
...
SECRET_KEY = 'django-insecure-o%2q8fb^36-m5_brv!x1m95!x0kso@@doh%(cxy^i*uokar*hu'
...
WSGI_APPLICATION = 'backsana.wsgi.application'
